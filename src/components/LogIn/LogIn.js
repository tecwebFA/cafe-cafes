...
return (  
    <div className="containerForm">
        ...
        <form autoComplete="off" className="form-group" onSubmit={logIn}>
            ...
            <button type='submit' className="btnConf">Acessar</button>
            <a href="#!" className="redirect" onClick={handleResetPassword}>Esqueceu a Senha? </a>
            </div>
        </form>
        <div className="buttonsExtra">
        <button onClick={handleGoogleSignin} className="btnConf google"><Icon icon={google3}></Icon> Ingressar com Google</button>
        <span className="redirect">Não está registrado?<Link to="/signup">Registrar</Link></span>
        </div>
